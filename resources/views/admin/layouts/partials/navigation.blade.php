<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
	<div class="navbar-header">
		...
		<div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
			<img class="navbar-brand-logo" src="/themes/remark/assets/images/logo-blue.png" title="Remark" />
	...
	<div class="navbar-container container-fluid">
		...
		<div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
			...
			<ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
				<li class="nav-item">
    				<a class="nav-link" href="{{ route('logout') }}" title="Sair" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
              			<i class="icon fa fa-sign-out" aria-hidden="true"></i> Sair
            		</a>
				...
				<ul class="site-menu" data-plugin="menu">
					...
					{{--<li class="site-menu-item">--}}
						{{--<a href="{{ route('cupons.index') }}">--}}
							...
							{{--<span class="site-menu-title">Cupom</span>--}}
						{{--</a>--}}
					{{--</li>--}}
					{{--<li class="site-menu-item">--}}
						...
						{{--</a>--}}
					{{--</li>--}}
					{{--<li class="site-menu-category">Pessoa Juridíca</li>--}}
					{{--<li class="site-menu-item">--}}
					...
					{{--</li>--}}
					{{--<li class="site-menu-item">--}}
						{{--<a href="{{ route('pedidos_empresa.index') }}">--}}
							{{--<i class="site-menu-icon fa-list" aria-hidden="true"></i>--}}
							{{--<span class="site-menu-title">Pedidos</span>--}}
						{{--</a>--}}
					{{--</li>--}}
					{{--<li class="site-menu-category">Relatórios</li>--}}
					{{--<li class="site-menu-item">--}}
						{{--<a href="{{ route('reports.venda') }}">--}}
					...
					{{--<li class="site-menu-item">--}}
						{{--<a href="{{ route('reports.venda') }}">--}}
							...
							{{--<span class="site-menu-title">Entregas</span>--}}
						{{--</a>--}}
					{{--</li>--}}
					<!--
